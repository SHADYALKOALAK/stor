...
class PurplerViewAdmin extends StatefulWidget {
  const PurplerViewAdmin({Key? key}) : super(key: key);

  @override
  State<PurplerViewAdmin> createState() => _PurplerViewAdminState();
}

class _PurplerViewAdminState extends State<PurplerViewAdmin>
  ...
  Future<void> chickData() async {
    ...
    if (title.isEmpty) {
      ...
      await FbAdminProductPurplerController().insert(
        ProductModel(
          id: id,
          titel: title,
          offer: offer,
