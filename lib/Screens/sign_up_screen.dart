...
class _SignUpScreenState extends State<SignUpScreen> with ChickData {
  ...
  Future<void> chickData() async {
    ...
    if (fullName.isEmpty) {
      showSnackBar(context, localizations.pleaseEnterYourFullName, Colors.red);
      ...
      showSnackBar(
          context, localizations.pleaseEnterYourConfirmPassword, Colors.red);
    } else if (cPassword != password) {
      showSnackBar(
          context, localizations.makeSureThePasswordMatches, Colors.red);
    } else if (!email.contains('@gmail.com')) {
      showSnackBar(context, localizations.pleaseEnterCorrectEmail, Colors.red);
    } else if (password.length < 6) {
      showSnackBar(context, localizations.passwordMusterLongerThanCharacters,
          Colors.red);
    } else {
      ...
      if (user != null) {
        ...
        showSnackBar(
            context, localizations.theAccountAlreadyExists, Colors.red);
        setState(() => loader = false);
      }
    }
  }
