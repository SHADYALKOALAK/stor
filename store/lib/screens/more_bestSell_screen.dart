...
class MoreBestSellScreen extends StatefulWidget {
  const MoreBestSellScreen({Key? key}) : super(key: key);

  @override
  State<MoreBestSellScreen> createState() => _MoreBestSellScreenState();
}

class _MoreBestSellScreenState extends State<MoreBestSellScreen> with NavHelper {
